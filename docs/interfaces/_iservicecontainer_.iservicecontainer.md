[@botflx/dependency-injection-container - v1.2.5](../README.md) › [Globals](../globals.md) › ["IServiceContainer"](../modules/_iservicecontainer_.md) › [IServiceContainer](_iservicecontainer_.iservicecontainer.md)
...
*Defined in [src/IServiceContainer.ts:57](https://github.com/botflux/dependency-injection-container/blob/f04dadf/src/IServiceContainer.ts#L57)*
...
*Defined in [src/IServiceContainer.ts:66](https://github.com/botflux/dependency-injection-container/blob/f04dadf/src/IServiceContainer.ts#L66)*
...
*Defined in [src/IServiceContainer.ts:85](https://github.com/botflux/dependency-injection-container/blob/f04dadf/src/IServiceContainer.ts#L85)*
...
*Defined in [src/IServiceContainer.ts:76](https://github.com/botflux/dependency-injection-container/blob/f04dadf/src/IServiceContainer.ts#L76)*
