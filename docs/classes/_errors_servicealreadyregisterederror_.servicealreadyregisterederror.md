...
*Defined in [src/errors/ServiceAlreadyRegisteredError.ts:1](https://github.com/botflux/dependency-injection-container/blob/68c7325/src/errors/ServiceAlreadyRegisteredError.ts#L1)*
