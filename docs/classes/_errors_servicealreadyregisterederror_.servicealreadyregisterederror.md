...
*Defined in [src/errors/ServiceAlreadyRegisteredError.ts:1](https://github.com/botflux/dependency-injection-container/blob/8392867/src/errors/ServiceAlreadyRegisteredError.ts#L1)*
